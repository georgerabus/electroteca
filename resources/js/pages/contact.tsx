    ...
    return (
        <AppLayout breadcrumbs={[{ title: 'Contact', href: '/contact' }]}>
            ...
            <div className="w-full bg-neutral-900 py-12">
                ...
                {/* --- Main Content Grid --- */}
                <div className="grid grid-cols-1 lg:grid-cols-3 bg-neutral-900 shadow-xl border border-neutral-800">
                    ...
                    <div className="lg:col-span-2 p-6 sm:p-10">
                        <form className="space-y-6">
                            ...
                            <button
                                type="submit"
                                className="w-full bg-white text-black font-semibold py-3 px-6 rounded-lg hover:bg-gray-100 transition duration-150 ease-in-out mt-6"
                            >
                                Send message
                            </button>
                        </form>
                    ...
                    <div className="bg-neutral-800 p-6 sm:p-10 space-y-10 lg:border-l border-neutral-700">
                        ...
                        <div>
                            ...
                            <p className="text-gray-300 mb-4">Call our team Mon-Fri from 8am to 5pm.</p>
                        ...
                        <div>
                            ...
                            <p className="text-gray-300 mb-4">Chat to us in person at Microlab, Tekwill.</p>
                            <div className="flex items-center text-white text-lg font-bold">
                                <span className="mr-2 text-red-600">📍</span>
